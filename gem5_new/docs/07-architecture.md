...
> 历史文档：下文记录 2026-09-08 独立子项目的功能内存与离线重放架构。
> 当前整机已使用单进程、1 fs、AXI256/UCIe/在线 mem_sim 响应闭环，见
> [当前详细架构](../../docs/architecture.md)。不要将下文 open-loop、1 ps 等描述用于当前验收。

历史版本读者可从[构建运行指南](08-build-run.md)复现，从
